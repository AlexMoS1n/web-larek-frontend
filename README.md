...
## Выполнение итогового задания к 9 спринту Мосиным Александром Сегеевичем на курсе фуллстек-разработчика платформы Яндекс.Практикум :flushed:

[Ссылка на репозиторий](https://github.com/AlexMoS1n/web-larek-frontend.git)

## Описание 
Построение интернет-магазина на архитектуре MVP.
